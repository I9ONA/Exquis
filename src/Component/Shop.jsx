...
const Shop = () => {
  ...
  const totalPages = Math.ceil(ShopsParfumes.length / itemsPerPage);

  const startIndex = (currentPage - 1) * itemsPerPage;
  const endIndex = startIndex + itemsPerPage;
  const currentItems = ShopsParfumes.slice(startIndex, endIndex);
  ...
  return (
    <div>
      <h1>Welcome to Our Parfum Store</h1>
